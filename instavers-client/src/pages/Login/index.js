...
function Login() {
    ...
    return (
        <div className="h-screen overflow-hidden flex items-center justify-center bg-pink-200">
                    ...
                    <div className=" sm:border-2 px-4 lg:px-24 py-10 lg:max-w-xl sm:max-w-md w-full text-center">
                        <form className="text-center px-3" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="py-2 text-left">
                                ...
                                />
                                {errors.password && (
                                    <span className="text-red-500 inline-block px-2">
                                ...
                                >
                                    {loading && (
                                        <div className="flex justify-center">
                                            <div className="border-2 border-white border-t-transparent w-5 h-5 animate-spin rounded-full"></div>
                                        </div>
                                    )}
