...
function Chat(props) {
    ...
    useEffect(() => {
        if (load_all_converstaion) {
            const fetchData = async () => {
                const response = await ChatAPI.get_all_conversation(
            ...
            <div className="group_chat">
                <div className="group_list_user">
                    <div className="header_list_user">
                        <p className="pt-3 text-center p_header_list_user">nkt.9920</p>
                    </div>
                    <hr />
                    <div>
                        <div className="pl-3 pr-3 group_message_search d-flex justify-content-between">
                            <p style={{ fontWeight: '600' }}>Messages</p>
                            <input
                                className="txt_message_search"
                                type="text"
                                placeholder="Search..."
                        ...
                        <div className="group_friend_chat">
                            {users &&
                                users.map((value) => (
                                    <div
                                        className={
                                            active_user === value._id
                                                ? 'group_personal d-flex p-3 personal_active'
                                                : 'group_personal d-flex p-3'
                                        }
                                        onClick={() => hander_Click_User(value._id)}
                                        key={value._id}
                                    >
                                        <img
                                            src={value.image_profile}
                                            alt=""
                                            className="image_personal"
                                        />
                                        ...
                                        {all_converstaion &&
                                            all_converstaion.map((e) => (
                                                <div key={e._id}>
                                                    {value._id === e.id_user2 &&
                                                        e.count_message > 0 && (
                ...
                <div className="group_list_message">
                    <div className="header_list_message d-flex">
                        {user_personal && (
                            <img
                                src={user_personal.image_profile}
                                alt=""
                                ...
                                <div key={value.id}>
                                    {value.category === 'send' ? (
                                        <div className="mt-1 d-flex justify-content-end">
                                            <a className="mt-1 a_message_send">{value.message}</a>
                                        </div>
                                    ) : (
                                        <div className="d-flex">
                                            <img
                                                src={user_personal.image_profile}
                                                alt=""
                                                className="mt-2 message_receive"
                                            />
                                            <a className="mt-1 ml-2 a_message_receive">
                                                {value.message}
                                            </a>
                                        </div>
                                    )}
                    ...
                    <div className="pb-3 pl-3 pr-3 footer_list_message">
                        <div className="icon_message_send d-flex">
                            <i
                                className="fa fa-smile-o fa-2x icon_footer"
                                style={{ cursor: 'pointer' }}
                            ></i>
                            <input
                                className="ml-3 input_footer"
                                type="text"
                                placeholder="Message..."
                                value={message}
                            ...
                            />
                            <i
                                className="ml-3 fa fa-send-o"
                                onClick={handler_send_message}
